$(document).ready(function(){
    ...
    var totalnum=0;//总条数
    var count=0;//分页总条数
    var querySourceTabNameAndNum = function(sourceTabName,status){
        ...
        $.ajax({
            ...
            dataType:"json",
            data:{"sourceTabName":sourceTabName,"dataSouceId":dataSouceId,"status":status},
            async : false,
            success : function(data) {
                if(typeof(data) != 'undefined' && data != null ){
                    ...
                    if (status=='notstart') {
                        ...
                        count=data.fail;
                    }else if (status=='wavestatus') {
                        count=data.wavestatus;
                    }else{
                        count=data.totalnum;
                    }
                    if (count == 0) {
    ...
    var refresh=function(dataCyle,page,status){
        ...
        sourceTabName = $("#sourceTabName").val();
        querySourceTabNameAndNum(dataCyle,sourceTabName,status);
        $.ajax({
            type:"GET",
